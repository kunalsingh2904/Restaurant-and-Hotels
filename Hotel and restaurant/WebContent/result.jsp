...
<%
	...
	if(rr==1){
		...
		out.print("<br><form action =\"addRestaurant.jsp\" method=\"post\" ><input type=\"hidden\" name=\"user\" value="+a1+"><input type=submit value=\"Add restaurant\" ></form>");
		out.print("<br><form action =\"home.jsp\" method=\"post\" ><input type=\"hidden\" name=\"user\" value="+a1+"><input type=submit value=\"Search restaurant\" ></form>");
